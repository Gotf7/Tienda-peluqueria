...
productos = [
    ...
    {"id": 13, "col_id": "crema-desrizadora-o-alisadora", "nombre": "Nevada Super Crema No-Lye Relaxer", "precio": "$1400 CUP", "img": "Derriz Nevada.jpg", "detalle": "Kit de desrizado enriquecido con vitamina E..."}
]
